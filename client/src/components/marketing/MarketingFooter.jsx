      ...
      <div className="mkt-footer-inner">
        <div className="mkt-footer-brand-section">
          <div className="mkt-footer-logo" aria-hidden="true">
            <img className="mkt-footer-logo-img" src="/logo.png" alt="NB Aurum Solutions" />
          </div>
          <p>
            NB Aurum Solutions is an enterprise SaaS platform for finance and operations teams. We help organizations
