...
const WHATSAPP_NUMBER = '919860894146'
const WHATSAPP_MESSAGE = 'Hi, I have a query regarding NB Aurum Solutions. Please help.'
  ...
  return (
    <div className="mkt-floating-buttons" aria-hidden="true">
      <a
        ...
        className="mkt-floating-btn mkt-floating-whatsapp"
      ...
      >
        ...
        <span className="mkt-floating-btn-label">Query</span>
      </a>
      <button
        type="button"
